...
const SignUp = () => {
    return (
        <div>   
            <div>
                <section className="bg-gray-50 dark:bg-gray-900 justify-center items-center">
                        ...
                        <div>
                            <div className="w-full lg:max-w-xl p-6 space-y-8 sm:p-8 bg-white rounded-lg shadow-xl dark:bg-gray-800">
                                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">
                                    Sign Up to <span className="text-orange-700">poke</span>mon
                                </h2>
                                <form className="mt-8 space-y-6" action="#">
                                    ...
                                    <div className="text-sm font-medium text-gray-900 dark:text-white">
                                        Already have an account? <Link href='/Login' className="text-blue-600 hover:underline dark:text-blue-500">Login</Link>
                                    </div>
                                </form>
                            </div>
                        </div>
